...
/*
  ...
  1. size_t* sai передали как входные данные, а функция их меняет. Это неочевидно для того, кто вызывает код
  2. Нет информации о размерах выходного массива. Функция по сути доверяет человеку, что массив достаточного размера, иначе при ошибке выход за границы
  3. Функция предполагает, что подмассивы отсортированы по убыванию, но это по сути никак не отражено в интерфейсе
  Ну и все, наверное...
*/
